                ...
                <div tw="bg-black flex">
                    <div tw="flex flex-col md:flex-row w-full p-12 gap-12 md:items-center justify-between">
                        <h2 tw="flex flex-col font-bold tracking-tight text-gray-900 text-left">
                            <span tw="text-white text-6xl">{decodeURI(name ?? "")}</span>
                            <span tw="text-indigo-600 text-5xl">{decodeURI(description ?? "")}</span>
                        </h2>

                        <div tw="flex p-4">
                            {imageUrl && <img tw="h-72 rounded" alt="" src={decodeURI(imageUrl)} />}
                        </div>
                    </div>
                </div>
            </div>
